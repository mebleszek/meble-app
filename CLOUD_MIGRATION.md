...
## Central help registry v1 — 2026-06-04

- Dodano `js/app/shared/help-registry.js` jako centralny rejestr opisów UI pod ikoną `?`. Moduł nie tworzy nowego storage i nie zmienia modelu danych użytkownika.
- Dynamiczne parametry techniczne okuć nadal pozostają w istniejącym katalogu/słownikach; helpery opisują znaczenie pól i nie są osobną prawdą danych biznesowych.
- Zmiana jest cloud-ready: opisy UI są odseparowane od zapisu katalogu i nie tworzą nowych trwałych kluczy localStorage.
