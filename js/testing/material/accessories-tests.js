  ...
  function collectTests(){
    return [
      ...
      H.makeTest('Akcesoria — zamienniki techniczne', 'Silnik zamienników jest tylko warstwą podglądu bez zapisu do storage', 'Chroni etap 2: testujemy dopasowanie okuć bez przycisków UI i bez modyfikowania katalogu/projektu.', ()=> withSnapshot(()=>{
        ...
        const result = engine.compareItems({ id:'src_preview', name:'Źródło', manufacturer:'Blum', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } } }, { id:'cand_preview', name:'Kandydat', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:107 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } } });
      ...
      H.makeTest('Akcesoria — zamienniki techniczne', 'Klasa zamienności kąta nie udaje innej funkcji zawiasu', 'Chroni nowy model: 107° w klasie 90–120 może zastąpić 110°, ale 170° narożny nie może.', ()=>{
        ...
        const definitions = [
          ...
          { category:'Zawiasy', key:'typ_prowadnika', label:'Typ prowadnika', fieldType:'text', compareMode:'equal', keyFeature:true, active:true },
          { category:'Zawiasy', key:'forma_prowadnika', label:'Forma prowadnika', fieldType:'text', compareMode:'equal', keyFeature:true, active:true },
        ...
        const source = { id:'hinge_src_110', name:'Zawias 110', manufacturer:'Blum', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false } } };
        const standard107 = { id:'hinge_107_standard', name:'Zawias 107 standard', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:107 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:12, useForQuote:true }] };
        const corner170 = { id:'hinge_170_corner', name:'Zawias 170 narożny', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:170 }, klasa_kata:{ value:'narożny 170°' }, typ_prowadnika:{ value:'specjalny' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:12, useForQuote:true }] };
        const noBrake = { id:'hinge_107_no_brake', name:'Zawias 107 bez hamulca', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:107 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:false }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:12, useForQuote:true }] };
      ...
      H.makeTest('Akcesoria — zamienniki techniczne', 'Wskazany producent ogranicza listę kandydatów', 'Chroni scenariusz Blum → GTV: kandydat z innego producenta nie przechodzi, nawet jeśli technicznie pasuje.', ()=>{
        ...
        const source = { id:'hinge_blum_src', name:'Blum hamulec', manufacturer:'Blum', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } } };
        const gtv = { id:'hinge_gtv_ok', name:'GTV hamulec', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:15, useForQuote:true }] };
        const rejs = { id:'hinge_rejs_ok', name:'Rejs hamulec', manufacturer:'Rejs', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:14, useForQuote:true }] };
      ...
      H.makeTest('Akcesoria — zamienniki techniczne', 'Brak ceny dostawcy jest ostrzeżeniem albo blokadą zależnie od opcji', 'Chroni przyszły podgląd: technicznie pasujące okucie bez ceny jest widoczne, ale może zostać zablokowane przy wymaganiu ceny.', ()=>{
        const engine = requireReplacement();
        const definitions = [{ category:'Zawiasy', key:'hamulec', label:'Hamulec', fieldType:'boolean', compareMode:'equal', keyFeature:true, active:true }];
        const source = { id:'price_src', name:'Źródło', manufacturer:'Blum', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } } };
        const noPrice = { id:'price_no', name:'Bez ceny', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } } };
        const withPrice = { id:'price_yes', name:'Z ceną', manufacturer:'GTV', hardwareCategory:'Zawiasy', technicalParams:{ nalozenie:{ value:'nakładany' }, kat_rzeczywisty:{ from:110 }, klasa_kata:{ value:'standardowy 90–120°' }, typ_prowadnika:{ value:'standardowy' }, forma_prowadnika:{ value:'krzyżowy' }, rola_kompletu:{ value:'komplet zawiasowy' }, system_kompatybilnosci:{ value:'GTV clip-on' }, pokrycie_prowadnika:{ value:'w komplecie' }, hamulec:{ value:true }, sprezyna:{ value:false }, sprezyna:{ value:false } }, supplierPrices:[{ supplierId:'mago', catalogPriceGross:10, useForQuote:true }] };
      ...
      H.makeTest('Akcesoria — dynamiczne dane techniczne', 'Parametry techniczne nie zapisują [object Object]', 'Chroni backup i przyszłą zamianę okuć: launchery/obiekty wyboru nie mogą trafiać do storage jako tekst [object Object].', ()=>{
        ...
        const row = hw.normalizeAccessory({
          ...
          technicalParams:{
            ...
            typ_prowadnika:{ value:{ label:'standardowy' } }, forma_prowadnika:{ value:{ label:'krzyżowy' } }, rola_kompletu:{ value:{ label:'komplet zawiasowy' } }, system_kompatybilnosci:{ value:{ label:'GTV clip-on' } }, pokrycie_prowadnika:{ value:{ label:'w komplecie' } }
          }
