(function(){
  ...
  const KEY_INFO = {
    ...
    fc_hardware_categories_v1:{ category:'user', label:'Okucia — kategorie', description:'Edytowalne kategorie okuć, które grupują słowniki, parametry techniczne i arkusze Excel.' },
    fc_hardware_types_v1:{ category:'user', label:'Okucia — typy i cechy', description:'Słownik typów/cech okuć używany dla zgodności i pomocniczych opisów katalogu.' },
