// Auto-generated split: Actions registry registrations
// Keeps all action handlers in one place.
// Loaded before js/app.js; app.js calls FC.actionsRegister(ctx).

(function(){
  window.FC = window.FC || {};

  window.FC.actionsRegister = function actionsRegister(ctx){
    const {
      FC,
      uiState,
      STORAGE_KEYS,
    ...
    if(!FC || !FC.actions || typeof FC.actions.register !== 'function') return false;
