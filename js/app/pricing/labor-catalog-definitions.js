...
(function(){
  ...
  const DEFAULT_LABOR_DEFINITIONS = [
    ...
    { id:'hood_mount', category:'Montaż AGD', name:'Montaż okapu', price:0, usage:'universal', rateType:'assembly', quantitySource:'appliance.hood.count', timeBlockHours:0.5, quantityMode:'linear', active:true, internalOnly:true, starterPrice:true, note:'Osobny automat AGD. Kod techniczny stały: hood_mount.' },
