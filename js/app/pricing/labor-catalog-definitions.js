...
(function(){
  ...
  const DEFAULT_HOURLY_RATES = [
    { id:'labor_rate_workshop', category:'Stawki godzinowe', name:'Stawka warsztatowa', price:120, autoRole:'hourlyRate', rateKey:'workshop', usage:'universal', active:true, starterPrice:true, note:'Cena startowa — sprawdzić przed realną ofertą.' },
    { id:'labor_rate_assembly', category:'Stawki godzinowe', name:'Stawka montażowa', price:140, autoRole:'hourlyRate', rateKey:'assembly', usage:'universal', active:true, starterPrice:true, note:'Cena startowa — sprawdzić przed realną ofertą.' },
    { id:'labor_rate_helper', category:'Stawki godzinowe', name:'Stawka pomocnika', price:60, autoRole:'hourlyRate', rateKey:'helper', usage:'universal', active:true, starterPrice:true, note:'Cena startowa — sprawdzić przed realną ofertą.' },
    { id:'labor_rate_specialist', category:'Stawki godzinowe', name:'Stawka specjalistyczna', price:180, autoRole:'hourlyRate', rateKey:'specialist', usage:'universal', active:true, starterPrice:true, note:'Cena startowa — sprawdzić przed realną ofertą.' },
  ];

  const DEFAULT_LABOR_DEFINITIONS = [
    { id:'labor_body_h072', category:'Korpusy', name:'Skręcenie korpusu do 72 cm', price:0, usage:'universal', autoRole:'cabinetBody', rateType:'workshop', timeBlockHours:0.5, defaultMultiplier:1.25, heightMinMm:0, heightMaxMm:720, volumePricePerM3:50, active:true, internalOnly:true, starterPrice:true, note:'Cena startowa — algorytm do sprawdzenia po testach realnej produkcji.' },
    { id:'labor_body_h150', category:'Korpusy', name:'Skręcenie korpusu do 150 cm', price:0, usage:'universal', autoRole:'cabinetBody', rateType:'workshop', timeBlockHours:1, defaultMultiplier:1.15, heightMinMm:721, heightMaxMm:1500, volumePricePerM3:50, active:true, internalOnly:true, starterPrice:true, note:'Cena startowa — algorytm do sprawdzenia po testach realnej produkcji.' },
    { id:'labor_body_h225', category:'Korpusy', name:'Skręcenie korpusu do 225 cm', price:0, usage:'universal', autoRole:'cabinetBody', rateType:'workshop', timeBlockHours:1, defaultMultiplier:1.6, heightMinMm:1501, heightMaxMm:2250, volumePricePerM3:50, active:true, internalOnly:true, starterPrice:true, note:'Cena startowa — algorytm do sprawdzenia po testach realnej produkcji.' },
    { id:'labor_body_h999', category:'Korpusy', name:'Skręcenie korpusu powyżej 225 cm', price:0, usage:'universal', autoRole:'cabinetBody', rateType:'workshop', timeBlockHours:1, defaultMultiplier:2.2, heightMinMm:2251, heightMaxMm:99999, volumePricePerM3:50, active:true, internalOnly:true, starterPrice:true, note:'Cena startowa — algorytm do sprawdzenia po testach realnej produkcji.' },
    { id:'labor_loose_shelves', category:'Elementy szafki', name:'Półki luźne — pakiet', price:0, usage:'universal', autoRole:'cabinetLooseShelves', rateType:'workshop', quantityMode:'tiers', quantityTiers:[{ min:1, max:2, hours:0.25 },{ min:3, max:5, hours:0.5 },{ min:6, max:10, hours:1 }], active:true, internalOnly:true, starterPrice:true, note:'Cena startowa — pakiety godzin do sprawdzenia.' },
    { id:'labor_mount_front', category:'Elementy szafki', name:'Montaż frontu / drzwi', price:0, usage:'universal', autoRole:'none', rateType:'workshop', timeBlockHours:0.25, quantityMode:'linear', active:true, internalOnly:true, starterPrice:true, note:'Cena startowa. Do ręcznego przypięcia przy szafce do czasu pełnego automatu frontów.' },
    { id:'labor_mount_hinge', category:'Elementy szafki', name:'Montaż zawiasu', price:0, usage:'universal', autoRole:'none', rateType:'workshop', timeBlockHours:0.25, quantityMode:'linear', active:true, internalOnly:true, starterPrice:true, note:'Cena startowa. Ilość odpowiada zawiasom.' },
