(function(){
  ...
  const getActiveRooms = selectionApi.getActiveRooms;
  const normalizeMaterialScope = selectionApi.normalizeMaterialScope;
  ...
  const decodeMaterialScope = selectionApi.decodeMaterialScope;
