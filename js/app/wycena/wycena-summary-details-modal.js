...
(function(){
  ...
  function renderTotal(container, register){
    ...
    const summaryRows = [
      ['Materiały', totals.materials], ['Akcesoria', totals.accessories], ['Robocizna szafek', totals.labor], ['Usługi dodatkowe', totals.quoteRates], ['Transport', totals.transport], ['Montaż AGD', totals.services], ['Rabat', -num(totals.discount)]
