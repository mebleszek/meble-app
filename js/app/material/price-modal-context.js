...
(function(){
  ...
  FC.priceModalContext = Object.assign(FC.priceModalContext || {}, {
    ...
    QUOTE_RATE_CATEGORIES:Array.isArray(catalogDomain.QUOTE_RATE_CATEGORIES) ? catalogDomain.QUOTE_RATE_CATEGORIES.slice() : ['Korpusy','Elementy szafki','Usługi przy szafce','Montaż','Montaż AGD','Pomiar','Transport','Projekt','Inne'],
