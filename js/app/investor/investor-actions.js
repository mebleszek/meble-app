(function(){
  ...
  function buildActionBarHtml(currentState){
    ...
    if(!state.isEditing){
      return '<button class="btn-danger" type="button" data-investor-action="delete">Usuń</button><button class="btn" type="button" data-investor-action="pdf">PDF</button><button class="btn" type="button" data-investor-action="edit">Edytuj</button>';
    }
    if(state.dirty){
