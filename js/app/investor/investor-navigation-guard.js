(function(){
  ...
  function apply(editing){
    ...
    try{
      document.querySelectorAll('.investor-room-quick-btn, .investor-add-room-btn, .investor-manage-rooms-btn, .investor-project-status-btn').forEach((btn)=> toggleDisabled(btn, disabled));
    }catch(_){ }
    try{
