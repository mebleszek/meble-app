...
(function(root){
  ...
  function getProfileConfig(profile){
    ...
    const map = {
      A: { seedLimit: 8,  rowSeedLimit: 5,  tailPasses: 1 },
      B: { seedLimit: 12, rowSeedLimit: 7,  tailPasses: 1 },
      C: { seedLimit: 18, rowSeedLimit: 10, tailPasses: 2 },
      D: { seedLimit: 24, rowSeedLimit: 14, tailPasses: 3 },
    };
