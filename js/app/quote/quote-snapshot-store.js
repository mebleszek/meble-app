(function(){
  ...
  function compactSnapshotLines(lines){
    ...
    return {
      ...
      project:(Array.isArray(src.project) ? src.project : []).map(compactLaborLine),
  ...
  function snapshotSizeBreakdown(snapshot){
    ...
    return {
      ...
      parts:{
        ...
        linesProject:jsonBytes(lines.project),
  ...
  function quoteFingerprintPayload(snapshot){
    ...
    return {
      ...
      totals: {
        ...
        project: roundFingerprintNumber(totals.project),
      ...
      lines: {
        ...
        project: linesFingerprint(lines.project),
