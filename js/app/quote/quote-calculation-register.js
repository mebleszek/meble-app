...
(function(){
  ...
  function normalizeRegisterLine(line, fallback){
    ...
    return {
      ...
      workAutomatCode:text(src.workAutomatCode || src.laborAutomatCode || src.automatCode || fb.workAutomatCode || fb.laborAutomatCode || ''),
      laborAutomatCode:text(src.workAutomatCode || src.laborAutomatCode || src.automatCode || fb.workAutomatCode || fb.laborAutomatCode || ''),
      ...
      if(details.length){
        details.forEach((part, partIndex)=>{
          ...
          const detailLine = normalizeRegisterLine({
            ...
            workAutomatCode:text(p.workAutomatCode || p.laborAutomatCode || p.automatCode),
            laborAutomatCode:text(p.workAutomatCode || p.laborAutomatCode || p.automatCode),
