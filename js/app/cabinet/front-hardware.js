(function(){
  ...
  ns.frontHardware = Object.assign({}, ns.frontHardware, {
    ...
    resolveDrawerDoorCount: hw.resolveDrawerDoorCount,
    ...
    hingesByWeightKg: hw.hingesByWeightKg,
    hingesByHeightMm: hw.hingesByHeightMm,
    hingeWidthAddOn: hw.hingeWidthAddOn,
    universalHingesPerDoor: hw.universalHingesPerDoor,
