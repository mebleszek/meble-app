(function(){
  ...
  const saveInvestorRooms = statusMirrors.saveInvestorRooms;
  const updateLoadedProject = statusMirrors.updateLoadedProject;
  const syncStatusMirrors = statusMirrors.syncStatusMirrors;
