(function(){
  ...
  // Odpowiedzialność modułu: zapis luster statusów projektu/pomieszczeń.
  // Ten plik nie decyduje o statusie biznesowym; tylko zapisuje wynik
  // wyliczony przez project-status-sync i odświeża zależne widoki.
