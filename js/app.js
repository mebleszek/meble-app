...
const FC = (function(){
  ...
  function callMigration(name, version, data){
    try{
      const mig = window.FC && window.FC.migrations && window.FC.migrations[name];
      if(typeof mig === 'function') return mig(data);
    }catch(_){ }
  ...
  function migrateV1toV2(data){ return callMigration('migrateV1toV2', 2, data); }
  function migrateV2toV3(data){ return callMigration('migrateV2toV3', 3, data); }
  function migrateV3toV4(data){ return callMigration('migrateV3toV4', 4, data); }
  function migrateV4toV5(data){ return callMigration('migrateV4toV5', 5, data); }
  function migrateV5toV6(data){ return callMigration('migrateV5toV6', 6, data); }
  function migrateV6toV7(data){ return callMigration('migrateV6toV7', 7, data); }
  function migrateV7toV8(data){ return callMigration('migrateV7toV8', 9, data); }
