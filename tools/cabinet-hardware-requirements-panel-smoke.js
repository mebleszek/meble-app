...
function loadContext(){
  const FC = { frontHardware:{ getHingeCountForCabinet(){ return 4; } } };
  const ctx = {
    window:{ FC },
    FC,
    console,
...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260603_hinge_requirements_cascade_keep_doors_v1'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
