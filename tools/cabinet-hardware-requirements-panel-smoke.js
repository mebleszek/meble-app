...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260602_cabinet_hardware_requirements_panel_v1'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
