...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260609_labor_quantity_source_selector_v1'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
