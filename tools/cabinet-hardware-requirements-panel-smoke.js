...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260611_labor_appliance_category_clean_rebase_v1'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
