...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260604_hinge_change_picker_fix_v2'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
