...
function runStaticCheck(){
  ...
  assert(html.includes('cabinet-hardware-requirements-panel.js?v=20260603_hinge_requirements_pair_buttons_stacked_v1'), 'index musi ładować moduł panelu wymagań z aktualnym cache-bustingiem');
