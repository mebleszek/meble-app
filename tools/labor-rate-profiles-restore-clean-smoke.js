...
assert(index.includes('20260609_labor_conditions_clean_model_no_front_extra_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260609_labor_conditions_clean_model_no_front_extra_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
...
const rows = labor.ensureDefaultDefinitions([
  { id:'legacy_assembly_wrong', category:'Stawki godzinowe', name:'Stawka montażowa', price:150, isHourlyRate:true, rateKey:'assembly', starterPrice:true },
  { id:'legacy_specialist_wrong', category:'Stawki godzinowe', name:'Stawka specjalistyczna', price:250, isHourlyRate:true, rateKey:'specialist', starterPrice:true },
]);
...
const withPainter = rows.concat([{ id:'labor_rate_painter', category:'Stawki godzinowe', name:'Lakiernik', price:220, isHourlyRate:true, rateKey:'painter', rateCode:'painter', rateType:'painter', active:true, nonDeletable:true }]);
