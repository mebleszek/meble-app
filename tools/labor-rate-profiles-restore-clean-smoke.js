...
assert(index.includes('20260618_wycena_boot_dependency_retry_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260618_wycena_boot_dependency_retry_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
