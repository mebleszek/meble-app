...
assert(index.includes('20260610_quote_history_storage_maintenance_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260610_quote_history_storage_maintenance_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
