...
assert(index.includes('20260610_labor_appliance_separate_automats_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260610_labor_appliance_separate_automats_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
