...
assert(index.includes('20260613_openrouteservice_transport_diag_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260613_openrouteservice_transport_diag_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
