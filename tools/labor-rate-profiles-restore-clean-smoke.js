...
assert(index.includes('20260615_project_design_parts_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260615_project_design_parts_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
