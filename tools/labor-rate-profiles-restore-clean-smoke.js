...
assert(index.includes('20260612_pricing_modes_auto_tests_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260612_pricing_modes_auto_tests_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
