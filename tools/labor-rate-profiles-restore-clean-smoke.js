...
assert(index.includes('20260609_work_quantity_facts_reader_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260609_work_quantity_facts_reader_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
