...
assert(index.includes('20260616_project_preparation_section_v1'), 'Brak aktualnego cache-bustingu w index.html.');
assert(read('dev_tests.html').includes('20260616_project_preparation_section_v1'), 'Brak aktualnego cache-bustingu w dev_tests.html.');
