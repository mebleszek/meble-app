...
assert(index.includes('20260613_carrying_lift_logistics_v1') && dev.includes('20260613_carrying_lift_logistics_v1'), 'index/dev_tests mają aktualny cache-busting');
