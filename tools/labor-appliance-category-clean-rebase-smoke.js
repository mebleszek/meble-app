...
assert(index.includes('20260613_openrouteservice_transport_diag_v1') && dev.includes('20260613_openrouteservice_transport_diag_v1'), 'index/dev_tests mają aktualny cache-busting');
