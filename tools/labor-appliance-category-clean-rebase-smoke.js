...
assert(index.includes('20260613_catalog_migration_test_fix_v1') && dev.includes('20260613_catalog_migration_test_fix_v1'), 'index/dev_tests mają aktualny cache-busting');
