...
const VERSION = '20260610_wycena_unsaved_preview_storage_fix_v1';
assert(index.includes(VERSION), 'index.html ma aktualny cache-busting dla poprawki WYCENY');
assert(diag.includes("const BUILD = '20260610_wycena_unsaved_preview_storage_fix_v1'"), 'diagnostyka WYCENY ma aktualny build');
