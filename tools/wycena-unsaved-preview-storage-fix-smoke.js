...
const VERSION = '20260610_labor_drawer_count_context_fix_v1';
assert(index.includes(VERSION), 'index.html ma aktualny cache-busting dla poprawki WYCENY');
assert(diag.includes("const BUILD = '20260610_labor_drawer_count_context_fix_v1'"), 'diagnostyka WYCENY ma aktualny build');
