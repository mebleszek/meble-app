...
assert(index.includes('20260609_labor_conditions_cascade_fields_v1') && dev.includes('20260609_labor_conditions_cascade_fields_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
