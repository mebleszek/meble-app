...
assert(index.includes('20260610_drawer_requirements_source_of_truth_v1') && dev.includes('20260610_drawer_requirements_source_of_truth_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
