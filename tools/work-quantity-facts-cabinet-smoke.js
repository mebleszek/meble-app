...
load('js/app/cabinet/cabinet-drawer-requirements.js', ctx);
...
[index, dev, loadGroups, fileList].forEach((src, idx)=> {
...
assert(index.includes('20260610_labor_cabinet_single_accordion_dedupe_v1') && dev.includes('20260610_labor_cabinet_single_accordion_dedupe_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
