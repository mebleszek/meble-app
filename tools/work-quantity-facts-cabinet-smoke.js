...
assert(index.includes('20260609_work_quantity_facts_reader_v1') && dev.includes('20260609_work_quantity_facts_reader_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
