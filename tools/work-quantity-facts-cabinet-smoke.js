...
assert(index.includes('20260614_labor_readable_modes_v1') && dev.includes('20260614_labor_readable_modes_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
