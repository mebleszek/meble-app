...
assert(index.includes('20260611_labor_appliance_category_clean_rebase_v1') && dev.includes('20260611_labor_appliance_category_clean_rebase_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
