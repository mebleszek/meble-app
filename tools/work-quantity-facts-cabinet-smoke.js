...
assert(index.includes('20260614_cabinet_derived_facts_v1') && dev.includes('20260614_cabinet_derived_facts_v1'), 'index/dev_tests mają cache-busting faktów roboczych');
