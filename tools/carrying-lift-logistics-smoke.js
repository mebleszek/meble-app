...
assert.ok(index.includes('js/app/pricing/carrying-logistics.js?v=20260614_cabinet_derived_facts_v1'), 'index loads carrying-logistics');
assert.ok(index.includes('js/app/investor/investor-carrying.js?v=20260614_cabinet_derived_facts_v1'), 'index loads investor-carrying');
assert.ok(devTests.includes('js/app/pricing/carrying-logistics.js?v=20260614_cabinet_derived_facts_v1'), 'dev_tests loads carrying-logistics');
assert.ok(devTests.includes('js/app/investor/investor-carrying.js?v=20260614_cabinet_derived_facts_v1'), 'dev_tests loads investor-carrying');
