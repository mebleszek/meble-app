...
const files = [
  ...
  'js/app/rozrys/rozrys-bootstrap-env.js',
  'js/app/rozrys/rozrys-panel-workspace.js',
  'js/app/rozrys/rozrys-render-shell.js',
...
const context = {
  ...
  __DEV_ASSETS__: {
    ...
    'js/app/rozrys/rozrys-render-shell.js': fs.readFileSync(path.join(rootDir, 'js/app/rozrys/rozrys-render-shell.js'), 'utf8'),
    ...
    'js/app/rozrys/rozrys-bootstrap-env.js': fs.readFileSync(path.join(rootDir, 'js/app/rozrys/rozrys-bootstrap-env.js'), 'utf8'),
