...
const files = [
  ...
  'js/app/rozrys/rozrys-accordion-bridge.js',
...
const context = {
  ...
  __DEV_ASSETS__: {
    ...
    'js/app/rozrys/rozrys-accordion-bridge.js': fs.readFileSync(path.join(rootDir, 'js/app/rozrys/rozrys-accordion-bridge.js'), 'utf8'),
