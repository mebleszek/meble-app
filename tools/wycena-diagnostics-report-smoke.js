...
async function main(){
  ...
  assert(index.includes('js/app/wycena/wycena-diagnostics.js?v=20260530_wycena_generate_single_flow_v1'), 'index.html nie ładuje diagnostyki z cache-bustingiem');
  assert(devTests.includes('js/app/wycena/wycena-diagnostics.js?v=20260530_wycena_generate_single_flow_v1'), 'dev_tests.html nie ładuje diagnostyki z cache-bustingiem');
