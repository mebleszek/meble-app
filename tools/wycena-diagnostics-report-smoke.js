...
async function main(){
  ...
  assert(index.includes('js/app/wycena/wycena-diagnostics.js?v=20260530_wycena_duplicate_modal_fix_v1'), 'index.html nie ładuje diagnostyki z cache-bustingiem');
  assert(devTests.includes('js/app/wycena/wycena-diagnostics.js?v=20260530_wycena_duplicate_modal_fix_v1'), 'dev_tests.html nie ładuje diagnostyki z cache-bustingiem');
