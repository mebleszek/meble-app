...
| --- | --- |
| Pliki JS | 346 |
| Skrypty w index.html | 270 |
| Skrypty w dev_tests.html | 303 |
| Krawędzie zależności po symbolach FC | 1806 |
...
| js/app/shared/schema.js | 96 | SHARED | niskie |
