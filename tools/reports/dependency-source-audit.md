...
| --- | --- |
| Pliki JS | 262 |
| Skrypty w index.html | 199 |
| Skrypty w dev_tests.html | 216 |
| Krawędzie zależności po symbolach FC | 1306 |
| Symbole FC z właścicielem produkcyjnym | 187 |
| Symbole FC z właścicielem razem | 210 |
| Pliki z ryzykiem wysokim / nie ruszać | 13 |
| Pliki z ryzykiem średnim | 45 |

## Obszary

| Obszar | Pliki | Linie | Storage refs | Dialog refs | Wysokie | Średnie |
| --- | --- | --- | --- | --- | --- | --- |
| TESTY | 40 | 9804 | 189 | 1 | 6 | 21 |
...
| js/app/investor/investors-store.js | 28 | INWESTOR | wysokie |
...
| js/testing/shared/harness.js | 24 | TESTY | niskie |
...
| js/testing/wycena/suites/core-offer-basics.js | 19 | TESTY | średnie |
| js/app/shared/constants.js | 18 | SHARED | niskie |
| js/testing/wycena/suites/project-status-mirrors-contract.js | 18 | TESTY | średnie |
...
| js/testing/wycena/fixtures.js | 15 | TESTY | średnie |
| js/app/investor/investor-persistence.js | 14 | INWESTOR | średnie |
| js/app/project/project-status-sync.js | 14 | PROJEKT | średnie |

## Największy wpływ drugiego poziomu

| Plik | Pliki pośrednio zależne | Obszar | Ryzyko |
| --- | --- | --- | --- |
| js/app/shared/storage.js | 99 | DANE/STORAGE | niskie |
| js/app/shared/utils.js | 97 | SHARED | niskie |
| js/app/shared/constants.js | 84 | SHARED | niskie |
| js/app/shared/room-registry.js | 69 | POMIESZCZENIA | niskie |
| js/app/project/project-store.js | 66 | PROJEKT | średnie |
| js/app/ui/info-box.js | 58 | UI | niskie |
...
| js/app/investor/session.js | 54 | INWESTOR | średnie |
| js/app.js | 53 | BOOT/APP SHELL | wysokie |
| js/app/shared/ui-state.js | 48 | SHARED | niskie |
| js/app/catalog/catalog-store.js | 47 | KATALOG/USŁUGI | średnie |
| js/app/investor/investor-persistence.js | 46 | INWESTOR | średnie |
| js/app/quote/quote-snapshot-store.js | 45 | WYCENA | średnie |
| js/app/rozrys/rozrys.js | 45 | ROZRYS | wysokie |
| js/app/rozrys/rozrys-shell.js | 44 | ROZRYS | niskie |
| js/app/wycena/wycena-core.js | 44 | WYCENA | wysokie |
| js/app/cabinet/cabinet-cutlist.js | 42 | SZAFKI | niskie |
| js/app/bootstrap/reload-restore.js | 41 | BOOT/APP SHELL | niskie |
...
| --- | --- | --- | --- | --- | --- | --- |
| js/testing/project/tests.js | wysokie | 15 | 835 | 12 | 29 | 600+ linii; dużo publicznych symboli FC; dużo zależnych plików; dużo zależności wychodzących; bezpośredni storage poza oczywistą granicą; łączy DOM/eventy i storage |
| js/app/investor/investors-store.js | wysokie | 10 | 610 | 28 | 57 | 600+ linii; dużo zależnych plików; bezpośredni storage poza oczywistą granicą |
| js/app/rozrys/rozrys.js | wysokie | 9 | 842 | 8 | 45 | 600+ linii; kilka zależnych plików; dużo zależności wychodzących |
| js/testing/wycena/suites/central-status-sync.js | wysokie | 9 | 643 | 14 | 22 | 600+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/app/wycena/wycena-core.js | wysokie | 9 | 540 | 17 | 44 | 400+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/testing/rozrys/tests.js | wysokie | 9 | 459 | 7 | 28 | 400+ linii; kilka zależnych plików; dużo zależności wychodzących; bezpośredni storage poza oczywistą granicą |
...
| js/testing/cabinet/tests.js | wysokie | 8 | 806 | 7 | 29 | 600+ linii; kilka zależnych plików; dużo zależności wychodzących |
| js/app/investor/investor-ui.js | wysokie | 8 | 592 | 7 | 22 | 400+ linii; kilka zależnych plików; dużo zależności wychodzących |
| js/app.js | wysokie | 8 | 591 | 24 | 53 | 400+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/tabs/wycena.js | wysokie | 8 | 590 | 6 | 23 | 400+ linii; kilka zależnych plików; dużo zależności wychodzących |
| js/testing/rozrys/suites/helpers-bridges.js | wysokie | 8 | 390 | 14 | 28 | 250+ linii; dużo publicznych symboli FC; dużo zależnych plików; dużo zależności wychodzących |
| js/app/quote/quote-scope-entry.js | średnie | 7 | 489 | 5 | 27 | 400+ linii; kilka zależnych plików; kilka zależności wychodzących |
...
| js/testing/wycena/suites/scope-entry.js | średnie | 6 | 361 | 14 | 22 | 250+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/testing/rozrys/suites/project-stock.js | średnie | 6 | 342 | 13 | 29 | 250+ linii; dużo zależnych plików; dużo zależności wychodzących |
...
| js/testing/wycena/suites/core-offer-workflow.js | średnie | 6 | 273 | 14 | 22 | 250+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/app/quote/quote-snapshot.js | średnie | 6 | 257 | 10 | 41 | 250+ linii; dużo zależnych plików; kilka zależności wychodzących |
| js/testing/wycena/suites/core-offer-basics.js | średnie | 6 | 252 | 19 | 29 | 250+ linii; dużo zależnych plików; dużo zależności wychodzących |
| js/testing/rysunek/tests.js | średnie | 6 | 117 | 7 | 29 | kilka zależnych plików; kilka zależności wychodzących; bezpośredni storage poza oczywistą granicą; systemowe dialogi |
| js/app/cabinet/cabinet-modal-set-wizard.js | średnie | 5 | 693 | 0 | 0 | 600+ linii; kilka zależności wychodzących |
| js/app/wycena/wycena-tab-selection.js | średnie | 5 | 452 | 2 | 16 | 400+ linii; kilka zależności wychodzących |
| js/app/project/project-status-sync.js | średnie | 5 | 318 | 14 | 36 | 250+ linii; dużo zależnych plików |
| js/app/rozrys/rozrys-scope.js | średnie | 5 | 317 | 11 | 40 | 250+ linii; dużo zależnych plików |
| js/app/quote/quote-snapshot-store.js | średnie | 5 | 315 | 30 | 45 | 250+ linii; dużo zależnych plików |
| js/app/project/project-status-manual-guard.js | średnie | 5 | 296 | 6 | 27 | 250+ linii; kilka zależnych plików; kilka zależności wychodzących |
...
| js/testing/wycena/suites/investor-integration.js | średnie | 5 | 247 | 14 | 22 | dużo zależnych plików; dużo zależności wychodzących |
| js/app/quote/quote-offer-store.js | średnie | 5 | 238 | 11 | 36 | dużo zależnych plików; kilka zależności wychodzących |
| js/testing/wycena/suites/architecture-contract.js | średnie | 5 | 220 | 14 | 22 | dużo zależnych plików; dużo zależności wychodzących |
| js/testing/wycena/suites/status-anti-regression.js | średnie | 5 | 161 | 14 | 22 | dużo zależnych plików; dużo zależności wychodzących |
...
- Pośrednio zależne pliki (99): js/app.js<br>js/app/bootstrap/app-state-bootstrap.js<br>js/app/bootstrap/app-ui-bootstrap.js<br>js/app/bootstrap/reload-restore.js<br>js/app/cabinet/cabinet-actions.js<br>js/app/cabinet/cabinet-modal-set-wizard.js<br>js/app/catalog/catalog-selectors.js<br>js/app/catalog/catalog-store.js +91
...
- Pośrednio zależne pliki (45): js/app/investor/investor-persistence.js<br>js/app/investor/investor-rooms.js<br>js/app/investor/investor-ui.js<br>js/app/project/project-status-manual-guard.js<br>js/app/project/project-status-mirrors.js<br>js/app/project/project-status-scope.js<br>js/app/project/project-status-sync.js<br>js/app/quote/quote-offer-store.js +37
...
- Bezpośrednio zależne pliki (28): js/app/investor/investor-persistence.js<br>js/app/investor/investor-project.js<br>js/app/investor/investor-rooms.js<br>js/app/project/project-status-manual-guard.js<br>js/app/project/project-status-mirrors.js<br>js/app/project/project-status-scope.js<br>js/app/project/project-store.js<br>js/app/quote/quote-offer-store.js +20
- Pośrednio zależne pliki (57): js/app/bootstrap/app-ui-bootstrap.js<br>js/app/investor/investor-actions.js<br>js/app/investor/investor-persistence.js<br>js/app/investor/investor-project.js<br>js/app/investor/investor-rooms.js<br>js/app/investor/investor-ui.js<br>js/app/project/project-bridge.js<br>js/app/project/project-status-manual-guard.js +49
...
- Bezpośrednio zależne pliki (27): js/app/investor/investor-room-actions.js<br>js/app/investor/investor-rooms.js<br>js/app/investor/investor-ui.js<br>js/app/project/project-status-mirrors.js<br>js/app/project/project-status-scope.js<br>js/app/quote/quote-offer-store.js<br>js/app/quote/quote-scope-entry.js<br>js/app/quote/quote-snapshot-scope.js +19
- Pośrednio zależne pliki (69): js/app/bootstrap/app-ui-bootstrap.js<br>js/app/cabinet/cabinet-actions.js<br>js/app/investor/investor-actions.js<br>js/app/investor/investor-project.js<br>js/app/investor/investor-room-actions.js<br>js/app/investor/investor-ui.js<br>js/app/material/material-edge-store.js<br>js/app/material/material-part-options.js +61
...
- Bezpośrednio zależne pliki (24): js/app/investor/investor-project.js<br>js/app/investor/investor-ui.js<br>js/app/project/project-bridge.js<br>js/app/project/project-status-manual-guard.js<br>js/app/project/project-status-mirrors.js<br>js/app/project/project-status-scope.js<br>js/app/quote/quote-offer-store.js<br>js/app/quote/quote-scope-entry.js +16
- Pośrednio zależne pliki (66): js/app.js<br>js/app/bootstrap/app-state-bootstrap.js<br>js/app/bootstrap/app-ui-bootstrap.js<br>js/app/cabinet/cabinet-actions.js<br>js/app/cabinet/cabinet-modal-set-wizard.js<br>js/app/investor/investor-actions.js<br>js/app/investor/investor-persistence.js<br>js/app/investor/investor-project.js +58
...
- Bezpośrednio zależne pliki (24): js/testing/cabinet/tests.js<br>js/testing/data-safety/tests.js<br>js/testing/dev-tests-registry.js<br>js/testing/investor/tests.js<br>js/testing/material/tests.js<br>js/testing/project/tests.js<br>js/testing/rysunek/tests.js<br>js/testing/service/tests.js +16
- Pośrednio zależne pliki (25): js/testing/cabinet/tests.js<br>js/testing/dev-tests-page.js<br>js/testing/dev-tests-registry.js<br>js/testing/investor/tests.js<br>js/testing/project/tests.js<br>js/testing/rozrys/suites/helpers-bridges.js<br>js/testing/rozrys/suites/project-stock.js<br>js/testing/rozrys/tests.js +17
...
- Pośrednio zależne pliki (58): js/app/bootstrap/app-ui-bootstrap.js<br>js/app/investor/investor-actions.js<br>js/app/investor/investor-ui.js<br>js/app/material/price-modal-filters.js<br>js/app/material/price-modal-item-form.js<br>js/app/material/price-modal-list.js<br>js/app/material/price-modal-options.js<br>js/app/material/price-modal-persistence.js +50
...
### js/testing/wycena/suites/project-status-mirrors-contract.js

- Obszar: TESTY
- Kategoria: test
- Ryzyko: średnie (dużo zależnych plików; dużo zależności wychodzących)
- Definiuje FC: registerWycenaTests, projectStatusMirrors, project
- Bezpośrednio zależne pliki (18): js/testing/cabinet/tests.js<br>js/testing/project/tests.js<br>js/testing/rozrys/suites/project-stock.js<br>js/testing/rysunek/tests.js<br>js/testing/wycena/fixtures.js<br>js/testing/wycena/suites/architecture-contract.js<br>js/testing/wycena/suites/central-status-sync.js<br>js/testing/wycena/suites/core-offer-basics.js +10
- Pośrednio zależne pliki (28): js/testing/cabinet/tests.js<br>js/testing/dev-tests-registry.js<br>js/testing/investor/tests.js<br>js/testing/project/tests.js<br>js/testing/rozrys/suites/helpers-bridges.js<br>js/testing/rozrys/suites/optimizer-contracts.js<br>js/testing/rozrys/suites/output-bootstrap.js<br>js/testing/rozrys/suites/project-stock.js +20
...
- Pośrednio zależne pliki (44): js/app/investor/investor-persistence.js<br>js/app/investor/investor-rooms.js<br>js/app/investor/investor-ui.js<br>js/app/material/price-modal-options.js<br>js/app/project/project-status-manual-guard.js<br>js/app/project/project-status-scope.js<br>js/app/quote/quote-offer-store.js<br>js/app/quote/quote-pdf.js +36
