...
assert.ok(api && api.VERSION === '20260618_wycena_boot_dependency_retry_v1', 'cabinetDerivedFacts API/version exists');
...
assert.ok(read('index.html').includes('js/app/cabinet/cabinet-derived-facts.js?v=20260618_wycena_boot_dependency_retry_v1'), 'index ładuje cabinet-derived-facts');
assert.ok(read('dev_tests.html').includes('js/app/cabinet/cabinet-derived-facts.js?v=20260618_wycena_boot_dependency_retry_v1'), 'dev_tests ładuje cabinet-derived-facts');
