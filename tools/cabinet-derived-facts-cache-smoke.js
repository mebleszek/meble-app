...
assert.ok(read('index.html').includes('js/app/cabinet/cabinet-derived-facts.js?v=20260614_diag_file_labor_view_v1'), 'index ładuje cabinet-derived-facts');
assert.ok(read('dev_tests.html').includes('js/app/cabinet/cabinet-derived-facts.js?v=20260614_diag_file_labor_view_v1'), 'dev_tests ładuje cabinet-derived-facts');
