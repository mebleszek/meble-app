...
const version = '20260611_company_transport_wycena_core_boot_fix_v1';
[
...
assert(investorTransport.includes('calculate-ors') && investorTransport.includes('openrouteservice.org') && investorTransport.includes('Otwórz trasę w mapach'), 'Panel inwestora nie ma tras/ORS/map');
