...
assert(index.includes('20260610_quote_diag_storage_cleanup_v1') && dev.includes('20260610_quote_diag_storage_cleanup_v1'), 'index/dev_tests mają cache-busting etapu podglądu poza modalem');
