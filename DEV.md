...
- 2026-03-14 step102: sortowanie elementów w pasie przeniesione na etap po akceptacji pasa. `optima-solver.js` i `strip-solver.js` nie używają już sortowania szerokości do wyboru składu pasa; ten sam zestaw elementów i te same obroty są teraz tylko przestawiane malejąco po szerokości dopiero przed zapisaniem/rysowaniem zaakceptowanego pasa. Podbito cache-bust workera do `20260314_band_sort_v2`.
